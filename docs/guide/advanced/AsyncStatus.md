...
<template>
  <div>
    <pro-form  :data="jsonData" :value="value" ref="form">
    </pro-form>
    <el-button style="float:right;margin-left: 10px" type="primary" @click="disabled">禁用姓名</el-button>
        <el-button style="float:right" type="primary" @click="disabled(false)">恢复姓名</el-button>
  </div>
</template>
...
<script>
  export default {
    ...
    methods: {
      disabled(status) {
        this.$refs.form.disabled(status,'personname')
      },
    }
  }
</script>
...
<template>
  <div>
    ...
    <el-button style="float:right;margin-left: 10px" type="primary" @click="hidden">隐藏姓名</el-button>
        <el-button style="float:right" type="primary" @click="hidden(false)">显示姓名</el-button>
  </div>
</template>
...
<script>
  export default {
    ...
    methods: {
      hidden(status) {
        this.$refs.form.hidden(status,'personname')
      },
    }
  }
</script>
